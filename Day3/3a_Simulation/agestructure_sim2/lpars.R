...
LMC=read.psv("pm.psv")
LMC=cbind(exp(LMC[,1]),LMC[,2],exp(LMC[,3]),exp(LMC[,4]),exp(LMC[,5])

lbs=c("K","r","q","precsig","prectau")
...
plot.pairs(LMC,label=lbs,prior=c(1,1,0,3,3),mome1=c(8,-1.38,0,3.79,1.71),mome2=c(0.25,0.51,0,0.0086,0.0102))
